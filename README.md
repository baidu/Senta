...
## 版本要求
运行本目录下的程序示例需要使用PaddlePaddle v1.1 版本。如果您的PaddlePaddle安装版本低于此要求，请按照[安装文档]
(http://paddlepaddle.org/documentation/docs/zh/1.1/beginners_guide/install/Start.html#paddlepaddle) 中的说明更新PaddlePaddle安装版本。
